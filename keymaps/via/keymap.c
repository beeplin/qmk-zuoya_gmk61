...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LT(3, KC_CAPS), KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            KC_ENT,
    ...
    [1] = LAYOUT_tkl_ansi(
        KC_F11,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_WH_L,  KC_WH_R,  KC_UNDS,  KC_LPRN,  KC_LCBR,  KC_RCBR,  KC_RPRN,  KC_BSPC,
 ...
 LCTL_T(KC_CAPS), KC_A,     KC_R,     KC_S,     KC_T,     KC_G,     KC_M,     KC_N,     KC_E,     KC_I,     KC_O,     KC_QUOT,            KC_ENT,
  ...
  LT(3, KC_LCTL), _______,  _______,                      _______,                                _______,  _______,  _______,            _______
    ...
    [2] = LAYOUT_tkl_ansi(
        ...
        KC_LALT,  KC_ESC,   KC_BSPC,  KC_UP,    KC_DEL,   KC_PGUP,  KC_HOME,  KC_INS,   KC_BTN1,  KC_BTN3,  KC_BTN2,  KC_MPRV,  KC_MNXT,  KC_MPLY,
