...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 LCTL_T(KC_ESC),        KC_A,     KC_R,     KC_S,     KC_T,     KC_G,     KC_M,     KC_N,     KC_E,     KC_I,     KC_O,     KC_QUOT,            KC_ENT,
        ...
        KC_CAPS,        KC_LGUI,  KC_LALT,                LT(2, KC_SPC),                                KC_LALT,  KC_APP,   KC_RCTL,            MO(4)
    ),
    [2] = LAYOUT_tkl_ansi(
 ...
 LSFT_T(KC_WH_D),       KC_BTN2,  KC_BTN3,  KC_BTN1,  KC_SPC,   KC_APP,   KC_UNDS,  KC_1,     KC_2,     KC_3,     KC_GRV,                       KC_RSFT,
