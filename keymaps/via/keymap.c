...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = { 
 ...
 LALT_T(KC_F11), LCTL_T(KC_HOME), KC_BSPC,  KC_UP,    KC_PGUP,  KC_PGDN,  KC_CIRC,  KC_7,     KC_8,     KC_9,     KC_DLR,   KC_MPRV,  KC_MNXT,  KC_MPLY,
 LCTL_T(KC_F12), LALT_T(KC_ESC),  KC_LEFT,  KC_ENT,   KC_RGHT,  KC_TAB,   KC_AT,    KC_4,     KC_5,     KC_6,     KC_0,     KC_APP,             KC_SCRL,
        KC_LSFT, LSFT_T(KC_END),  KC_DEL,   KC_DOWN,  KC_WH_L,  KC_WH_R,  KC_UNDS,  KC_1,     KC_2,     KC_3,     KC_ASTR,                      KC_RSFT,
