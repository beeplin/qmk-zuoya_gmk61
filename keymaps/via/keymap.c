...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = { 
    ...
    [2] = LAYOUT_tkl_ansi(
        KC_TILD,        KC_LT,    KC_MINS,  KC_EQL,   KC_GT,    KC_PIPE,  KC_PERC,  KC_AMPR,  KC_LCBR,  KC_LPRN,  KC_RPRN,  KC_RCBR,  KC_HASH,  KC_EXLM,
        KC_GRV ,        KC_Q,     KC_W,     KC_F,     KC_P,     KC_B,     KC_J,     KC_L,     KC_U,     KC_Y,     KC_SCLN,  KC_LBRC,  KC_RBRC,  KC_BSLS,
 LCTL_T(KC_CAPS),       KC_A,     KC_R,     KC_S,     KC_T,     KC_G,     KC_M,     KC_N,     KC_E,     KC_I,     KC_O,     KC_QUOT,            KC_PLUS,
        KC_LSFT,        KC_Z,     KC_X,     KC_C,     KC_D,     KC_V,     KC_K,     KC_H,     KC_COMM,  KC_DOT,   KC_SLSH,                      CW_TOGG,
 ...
 LALT_T(KC_F11), LALT_T(KC_HOME), KC_BSPC,  KC_UP,    KC_PGUP,  KC_DEL,   KC_CIRC,  KC_7,     KC_8,     KC_9,     KC_DLR,   KC_MPRV,  KC_MNXT,  KC_MPLY,
 LCTL_T(KC_F12), LCTL_T(KC_ESC),  KC_LEFT,  KC_ENT,   KC_RGHT,  KC_PGDN,  KC_AT,    KC_4,     KC_5,     KC_6,     KC_0,     KC_APP,             KC_SCRL,
        KC_LSFT, LSFT_T(KC_END),  KC_TAB,   KC_DOWN,  KC_WH_L,  KC_WH_R,  KC_UNDS,  KC_1,     KC_2,     KC_3,     KC_ASTR,                      KC_RSFT,
 LCTL_T(KC_BRID),       KC_LGUI,  KC_LALT,                      KC_NO,                                  KC_LALT,  KC_RGUI,  RCTL_T(KC_BRIU),    TO(0)
    ),
    [4] = LAYOUT_tkl_ansi(
