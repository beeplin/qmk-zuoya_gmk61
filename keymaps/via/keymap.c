...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LT(3, KC_CAPS), KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            KC_ENT,
    ...
    [1] = LAYOUT_tkl_ansi(
        KC_F11,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_BRID,  KC_BRIU,  KC_UNDS,  KC_LPRN,  KC_LCBR,  KC_RCBR,  KC_RPRN,  KC_BSPC,
 ...
 LCTL_T(KC_CAPS), KC_A,     KC_R,     KC_S,     KC_T,     KC_G,     KC_M,     KC_N,     KC_E,     KC_I,     KC_O,     KC_QUOT,            KC_ENT,
  ...
  LT(3, KC_LCTL), _______,  _______,                      _______,                                _______,  _______,  _______,            _______
    ),
    [2] = LAYOUT_tkl_ansi(
        KC_F12,   KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_PSCR,  KC_SCRL,  KC_PAUS,  KC_WH_L,  KC_WH_R,  KC_VOLD,  KC_VOLU,  KC_MUTE,
        KC_LALT,  KC_ESC,   KC_BSPC,  KC_UP,    KC_DEL,   KC_PGUP,  KC_HOME,  KC_INS,   KC_LPRN,  KC_LCBR,  CW_TOGG,  KC_MPRV,  KC_MNXT,  KC_MPLY,
        _______,  KC_ENT,   KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_PGDN,  KC_END,   KC_GT,    KC_MINS,  KC_EQL,   KC_BSLS,  KC_GRV,             KC_SPC,
    ...
    [3] = LAYOUT_tkl_ansi(
        ...
        KC_APP,   KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_SCRL,  KC_MPRV,  KC_BTN4,  KC_WH_U,  KC_BTN5,  KC_VOLU,  KC_BRIU,  KC_SCRL,  KC_PAUS,
        _______,  KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_PAUS,  KC_MNXT,  KC_WH_L,  KC_WH_D,  KC_WH_R,  KC_VOLD,  KC_BRID,            KC_APP,
        _______,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_PSCR,  KC_MPLY,  KC_BTN1,  KC_BTN3,  KC_BTN2,  KC_MUTE,                      _______,
