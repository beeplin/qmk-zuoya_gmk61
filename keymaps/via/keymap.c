...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LT(3, KC_CAPS),  KC_LGUI,  KC_LALT,                LT(2, KC_SPC),                                KC_RALT,  KC_RGUI,  KC_RCTL,      LT(4, KC_APP)
    ...
    [2] = LAYOUT_tkl_ansi(
        ...
        KC_SPC,    KC_ESC,   KC_BSPC,  KC_UP,    KC_DEL,   KC_PGUP,  KC_HOME,  KC_GT,    KC_MINS,  KC_EQL,   KC_BSLS,  KC_RBRC,  KC_SCRL,  KC_PAUS,
        ...
        KC_INS,    KC_LGUI,  KC_LALT,                      KC_SPC,                                 KC_RALT,  KC_RGUI,  KC_RCTL,            KC_PWR
    ),
    [3] = LAYOUT_tkl_ansi(
        ...
        KC_LCTL,   KC_LGUI,  KC_LALT,                      KC_MSEL,                                KC_RALT,  KC_RGUI,  KC_RCTL,            TG(1)
    ),
    [4] = LAYOUT_tkl_ansi(
