...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_tkl_ansi(
        ...
        KC_LCTL,         KC_LGUI,  KC_LALT,                LT(2, KC_SPC),                                KC_LALT,  KC_APP,   KC_RCTL,      LT(3, KC_GRV)
    ),
    [1] = LAYOUT_tkl_ansi(
        KC_ESC,          KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,
        ...
        KC_CAPS,         KC_LGUI,  KC_LALT,                LT(2, KC_SPC),                                KC_LALT,  KC_APP,   KC_RCTL,      LT(3, KC_GRV)
    ),
    [2] = LAYOUT_tkl_ansi(
 ...
 LCTL_T(KC_WH_U),        KC_ENT,   KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_PGDN,  KC_END,   KC_4,     KC_5,     KC_6,     KC_EQL,   KC_BRID,            KC_BRIU,
 LSFT_T(KC_WH_D),        KC_BTN2,  KC_BTN3,  KC_BTN1,  KC_BTN4,  KC_BTN5,  KC_MINS,  KC_1,     KC_2,     KC_3,     KC_GRV,                       KC_RSFT,
