 ...
 LCTL_T(KC_ESC),  KC_A,     KC_R,     KC_S,     KC_T,     KC_G,     KC_M,     KC_N,     KC_E,     KC_I,     KC_O,     KC_QUOT,            KC_ENT,
  ...
  LT(3, KC_CAPS), _______,  _______,                      _______,                                _______,  _______,  _______,            _______
    ...
    [2] = LAYOUT_tkl_ansi(
        ...
        KC_HOME,  KC_END,   KC_BSPC,  KC_UP,    KC_DEL,   KC_PGUP,  KC_PPLS,  KC_PMNS,  KC_MINS,  KC_EQL,   KC_BSLS,  KC_MPRV,  KC_MNXT,  KC_MPLY,
        _______,  KC_ENT,   KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_PGDN,  KC_GT,    KC_LCBR,  KC_LPRN,  KC_RPRN,  KC_RCBR,  KC_GRV,             KC_SPC,
        _______,  KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,                         _______,
        KC_INS,   _______,  _______,                      _______,                                _______,  _______,  _______,            KC_SLEP
    ),
    [3] = LAYOUT_tkl_ansi(
